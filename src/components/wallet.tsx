  ...
  return (
    <motion.div className="relative border w-96 h-96 rounded-xl border-neutral-200 shadow-sm bg-neutral-50 p-1">
      <div className="h-full w-full flex justify-center items-center">
        <motion.div
          className="relative w-36 border h-36 rounded-4xl bg-neutral-800 shadow-xl"
          onHoverStart={() => onHover("start")}
          onHoverEnd={() => onHover("end")}
        >
          <div
            className="bg-inherit w-full h-16 absolute z-1 bottom-0 rounded-br-4xl rounded-bl-4xl overflow-hidden"
            style={{
