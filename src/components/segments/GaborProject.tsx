        ...
        <div className="flex flex-col justify-center items-center">
          <div className="relative w-full flex flex-col justify-start items-center">
            ...
            <div className="hidden peer-hover:block">
              <div className="absolute w-24 h-24 bg-neutral-400 rounded-xl -top-8 left-2 -rotate-12 overflow-hidden border border-neutral-200 shadow-md">
                <Image
              ...
              <div className="absolute w-24 h-24 bg-neutral-400 rounded-xl -top-28 left-1/2 rotate-6"></div>
              <div className="absolute w-24 h-24 bg-neutral-400 rounded-xl top-2 right-2 rotate-12"></div>
            </div>
          </div>
          ...
          <div className="relative w-full flex flex-col justify-center items-center">
            ...
            <div className="hidden peer-hover:block">
              <div className="absolute w-24 h-24 bg-neutral-400 rounded-xl -top-10 left-4 -rotate-12"></div>
              <div className="absolute w-24 h-24 bg-neutral-400 rounded-xl -top-36 left-32 rotate-6"></div>
              <div className="absolute w-24 h-24 bg-neutral-400 rounded-xl -top-12 right-6 rotate-12"></div>
            </div>
          </div>
        </div>
      </div>
